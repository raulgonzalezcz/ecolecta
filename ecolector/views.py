...
def show_reportes(request):
    ...
    return render(request, 'ecolector/reportes.html', context)
...
def show_rutas_disponibles(request):
    routes_data = [["2018-09-29 05:57", 100398, "Angelopólis Sur", 999.50, 10],["2018-09-28 03:17", 100397, "Valle del Sol", 1909.10, 21], ["2018-09-26 07:59", 100395, "Angelopólis Sur", 750.50, 15]]
    actual_route = True
    context = {
        "routes_data": routes_data,
    ...
    return render(request, 'ecolector/ruta_disponible.html', context)

def show_rutas_completadas(request):
    routes_data = [["2018-09-29 05:57", 100398, "Angelopólis Sur", 999.50, 10],["2018-09-28 03:17", 100397, "Valle del Sol", 1909.10, 21], ["2018-09-26 07:59", 100395, "Angelopólis Sur", 750.50, 15]]
    actual_route = True
    context = {
        "routes_data": routes_data,
    ...
    return render(request, 'ecolector/ruta_completada.html', context)